...
export default function diagnosticsDash() {
    ...
    const showUserChat = () => {
        ...
        setBackIconVisible(false);
        {
            /* False here because I created a separate back button for this page */
        }
        setUserChatVisible(true);
    };
    ...
    const data = [
        ...
        [
            'Adam Turner',
            'N/A',
            "The price isn't specified for the accomodation",
        ],
    ...
    const showSpecificChat = (key) => {
        ...
        setCurrentUser(key);
        {
            /* The name of the person clicked on was passed to the function */
        }
    };
    ...
    return (
        <SafeAreaView style={styles.safeContainer}>
            ...
            <ScrollView>
                ...
                {displayGraph ? (
                    <View>
                        <Text style={styles.lineGraphTitle}>
                            {' '}
                ...
                {displayDevForm ? (
                    <View style={{ margin: 20 }}>
                        ...
                        <TextInput
                            style={[styles.nameInput, styles.problemInput]}
                            placeholder="Problem"
                            multiline
                            placeholderTextColor="gray"
                            backgroundColor="#cfcfcf"
                ...
                {displayProblemTable ? (
                    <View style={styles.tableContainer}>
                        <Text style={styles.tableTitle}>
                            {' '}
                            Unsolved problems reported by users{' '}
                        </Text>
                ...
                {displaySpecificChat ? (
                    ...
                    >
                        <View style={styles.chatHeaderBorder}>
                            ...
                            <View style={styles.rowBox}>
                                <Image
                                    style={styles.specificUserImage}
                                    source={require('../../assets/user.png')}
                                />
                            </View>

                            <View style={[styles.rowBox]}>
                                <Text style={styles.specificUserName}>
                                    {' '}
                                    {currentUser}{' '}
                                </Text>
                            </View>
