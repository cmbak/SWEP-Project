...
import { ip_address, key } from '../../../consts';
    ...
    const fetchData = async () => {
      if (listings) {
        try {
          ...
          console.log(`Listings detailed length ${listingDetailed.length}`);
          ...
          <View style={styles.searchResults}>
            {listings &&
              ...
              listingDetailed.map((listing, index) => (
                ...
                >
                  <View
                    style={[styles.propertyOverview, styles.shadow]}
                    key={listing.id}
                  >
                    {/* Property Image */}
                    <ImageBackground
